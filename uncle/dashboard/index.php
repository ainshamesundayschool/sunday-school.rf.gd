...
═══════════════════════════════════════════════════════════════ */
        ...
        [data-theme="dark"] .stat-tile-icon.pink {
...
═══════════════════════════════════════════════════════════════ */
        ...
        .pending-search-row .search-input {
            flex: 1;
            font-size: .82rem;
            padding: 8px 12px
        }

        .pending-search-row .search-btn {
            padding: 8px 12px;
            font-size: .82rem
        }
        ...
        .reg-expand-toggle:hover {
            border-color: var(--brand);
            color: var(--brand);
            background: var(--brand-bg)
        }

        .reg-expand-toggle.open {
        ...
        .reg-details.open {
            display: block;
            animation: fadeSlideDown .18s ease both
        }
        ...
        .reg-select-row input[type=checkbox] {
            width: 15px;
            height: 15px;
            cursor: pointer;
        ...
        [data-theme="dark"] .export-preview-wrap {
            background: #fff;
            color: #1e293b
        }
        ...
        .custom-export-table tr:nth-child(even) td {
            background: #f8fafc
        }

        .custom-export-table .att-p {
...
═══════════════════════════════════════════════════════════════ */
        ...
        [data-theme="dark"] .attendance-actions {
        ...
        [data-theme="dark"] .student-coupons {
        ...
        .coupon-toggle-btn.minus {
            background: var(--danger-bg);
            color: var(--danger)
        }

        .coupon-toggle-btn.plus {
            background: var(--success-bg);
            color: var(--success)
        }
        ...
        [data-theme="dark"] .coupon-value-display {
            color: var(--brand-light)
        }

        .coupon-value-display:hover {
        ...
        .coupon-value-display[data-idx="0"]::after {
            background: radial-gradient(circle, currentColor 2.5px, transparent 2.5px) 0 0, radial-gradient(circle, currentColor 2px, transparent 2px) 11px 0, radial-gradient(circle, currentColor 2px, transparent 2px) 22px 0, radial-gradient(circle, currentColor 2px, transparent 2px) 33px 0;
            background-size: 11px 5px;
            background-repeat: no-repeat;
            opacity: .5
        }

        .coupon-value-display[data-idx="1"]::after {
            background: radial-gradient(circle, currentColor 2px, transparent 2px) 0 0, radial-gradient(circle, currentColor 2.5px, transparent 2.5px) 11px 0, radial-gradient(circle, currentColor 2px, transparent 2px) 22px 0, radial-gradient(circle, currentColor 2px, transparent 2px) 33px 0;
            background-size: 11px 5px;
            background-repeat: no-repeat;
            opacity: .5
        }

        .coupon-value-display[data-idx="2"]::after {
            background: radial-gradient(circle, currentColor 2px, transparent 2px) 0 0, radial-gradient(circle, currentColor 2px, transparent 2px) 11px 0, radial-gradient(circle, currentColor 2.5px, transparent 2.5px) 22px 0, radial-gradient(circle, currentColor 2px, transparent 2px) 33px 0;
            background-size: 11px 5px;
            background-repeat: no-repeat;
            opacity: .5
        }

        .coupon-value-display[data-idx="3"]::after {
            background: radial-gradient(circle, currentColor 2px, transparent 2px) 0 0, radial-gradient(circle, currentColor 2px, transparent 2px) 11px 0, radial-gradient(circle, currentColor 2px, transparent 2px) 22px 0, radial-gradient(circle, currentColor 2.5px, transparent 2.5px) 33px 0;
            background-size: 11px 5px;
            background-repeat: no-repeat;
            opacity: .5
        }
        ...
        [data-theme="dark"] .present-btn:hover {
            color: #fff
        }
        ...
        [data-theme="dark"] .absent-btn {
            background: rgba(239, 68, 68, .18);
            color: #fca5a5
        }

        [data-theme="dark"] .absent-btn:hover {
            color: #fff
        }
...
*/
        ...
        .modal.closing {
            animation: sheetDown .25s var(--ease) forwards
        }
...
═══════════════════════════════════════════════════════════════ */
        ...
        [data-theme="dark"] .detail-icon.pink {
            background: rgba(219, 39, 119, .15)
        }
        ...
        [data-theme="dark"] .detail-icon.teal {
...
═══════════════════════════════════════════════════════════════ */
        ...
        .input-icon-wrap select.form-input {
            padding-right: 36px
        }
...
═══════════════════════════════════════════════════════════════ */
        ...
        @media (max-width: 599px) {
            ...
            .table-container:not(.sheet-container) .data-table thead {
                display: none;
                /* hide original header — labels shown via data-label */
            }
            ...
            .table-container:not(.sheet-container) .data-table td:empty {
                display: none;
            }
        }
        ...
        [data-theme="dark"] .sheet-container .data-table th:first-child {
            background: var(--surface-3);
        }
        ...
        .attendance-present {
            background: linear-gradient(135deg, var(--success-bg), rgba(167, 243, 208, .6)) !important;
            color: #065f46;
            font-weight: 700;
            text-align: center
        }
        ...
        .attendance-absent {
            background: linear-gradient(135deg, var(--danger-bg), rgba(254, 202, 202, .6)) !important;
            color: #991b1b;
            font-weight: 700;
            text-align: center
        }
...
═══════════════════════════════════════════════════════════════ */
        ...
        .friday-item.selected {
            background: linear-gradient(135deg, var(--brand), var(--brand-dark));
            border-color: var(--brand);
            color: #fff
        }

        .friday-item.selected .friday-stats-row {
            color: rgba(255, 255, 255, .85) !important
        }

        .friday-item.current-week {
            box-shadow: 0 0 0 3px rgba(16, 185, 129, .3)
        }

        .friday-item.custom-date {
            border-color: rgba(245, 158, 11, .5);
            border-style: dashed
        }

        .friday-item.custom-date:hover {
            border-color: var(--warning);
            border-style: solid
        }

        .friday-item.custom-date.selected {
            background: linear-gradient(135deg, var(--warning), var(--warning-dark));
            border-color: var(--warning);
            border-style: solid
        }

        .friday-item .current-badge {
            position: absolute;
            top: -7px;
            right: -7px;
            background: var(--success);
        ...
        .friday-item:hover .delete-custom-btn {
            opacity: 1
        }

        .friday-item .delete-custom-btn:hover {
            background: var(--danger);
            color: #fff
        }
        ...
        .friday-item.selected .friday-num,
        .friday-item.selected .friday-day,
        .friday-item.selected .friday-date {
            color: #fff !important
        }

        .friday-item.custom-date .friday-num {
            color: var(--warning-dark)
        }

        .friday-item.custom-date.selected .friday-num {
            color: #fff !important
        }
        ...
        .friday-stats-row .fs-div {
            opacity: .3;
            font-size: .5rem
        }

        [data-theme="dark"] .friday-stats-row .fs-p {
            color: #6ee7b7
        }

        [data-theme="dark"] .friday-stats-row .fs-a {
            color: #fca5a5
        }
        ...
        [data-theme="dark"] .custom-date-section h4 {
            color: #fbbf24
        }
        ...
        .custom-date-chip:hover {
            background: var(--warning);
            color: #fff;
            border-color: var(--warning)
        }

        .custom-date-chip .cdel {
        ...
        .photo-circle-wrap:hover .photo-circle-placeholder {
...
═══════════════════════════════════════════════════════════════ */
        ...
        .all-students-table-container .data-table td::before {
            display: none !important;
        }
        ...
        .swipe-card-photo-placeholder i {
            font-size: 4rem;
            color: var(--brand);
            opacity: .25;
        }

        .swipe-card-photo-placeholder span {
            font-size: .78rem;
            color: var(--text-3);
            font-family: Cairo, sans-serif;
        }
        ...
        .swipe-stamp.present-stamp {
            left: 18px;
            color: #059669;
            transform: rotate(-10deg);
        }

        .swipe-stamp.absent-stamp {
            right: 18px;
            color: #dc2626;
            transform: rotate(10deg);
        }

        [data-theme="dark"] .swipe-stamp.present-stamp {
            color: #34d399;
        }

        [data-theme="dark"] .swipe-stamp.absent-stamp {
            color: #f87171;
        }
        ...
        .swipe-prev-pill.present {
            background: var(--success-bg);
            color: var(--success-dark);
            border-color: rgba(16, 185, 129, .2);
        }

        .swipe-prev-pill.absent {
            background: var(--danger-bg);
            color: var(--danger-dark);
            border-color: rgba(239, 68, 68, .2);
        }

        .swipe-prev-pill.pending {
            background: var(--surface-3);
            color: var(--text-3);
            border-color: var(--border-solid);
        }
        ...
        .swipe-absent-btn:active,
        .swipe-present-btn:active {
        ...
        .swipe-done-icon {
            ...
            margin-bottom: 18px;
            animation: bounceIn .55s var(--spring);
        }
        ...
        .swipe-card-label.present-lbl {
            left: 18px;
            color: #059669;
            transform: rotate(-10deg);
        }

        .swipe-card-label.absent-lbl {
            right: 18px;
            color: #dc2626;
            transform: rotate(10deg);
        }

        [data-theme="dark"] .swipe-card-label.present-lbl {
            color: #34d399;
        }

        [data-theme="dark"] .swipe-card-label.absent-lbl {
            color: #f87171;
        }
        ...
        .nps-icon.type-registration {
            background: #dbeafe;
            color: #1d4ed8;
        }

        .nps-icon.type-task_submission {
            background: #fef3c7;
            color: #b45309;
        }

        .nps-icon.type-developer_message {
            background: #ede9fe;
            color: #6d28d9;
        }

        .nps-icon.type-system {
            background: #f0fdf4;
            color: #166534;
        }

        .nps-icon.type-announcement {
            background: #fff7ed;
            color: #c2410c;
        }

        .nps-icon.type-default {
            background: var(--brand-bg);
            color: var(--brand);
        }

        [data-theme="dark"] .nps-icon.type-registration {
            background: rgba(29, 78, 216, .2);
            color: #93c5fd;
        }

        [data-theme="dark"] .nps-icon.type-task_submission {
            background: rgba(180, 83, 9, .2);
            color: #fcd34d;
        }

        [data-theme="dark"] .nps-icon.type-developer_message {
            background: rgba(109, 40, 217, .2);
            color: #c4b5fd;
        }

        [data-theme="dark"] .nps-icon.type-system {
            background: rgba(22, 101, 52, .2);
            color: #86efac;
        }

        [data-theme="dark"] .nps-icon.type-announcement {
        ...
        .nps-item:hover .nps-item-action {
            background: var(--brand);
            color: #fff;
        }
    ...
    <div class="image-modal" id="imageModal"
        ...
        <div class="image-modal-toolbar">
            ...
            <div style="display:flex;gap:8px;align-items:center">
                ...
                <button class="img-modal-btn" onclick="_imgZoomChange(-0.3)" title="تصغير"><i
                        class="fas fa-search-minus"></i></button>
                <button class="img-modal-btn" onclick="_imgZoomReset()" title="إعادة ضبط"><i
                        class="fas fa-compress-arrows-alt"></i></button>
                <button class="img-modal-btn" onclick="_imgDownload()" title="تحميل"><i
                    ...
                    <div class="action-dropdown">
                        ...
                        <div class="dropdown-menu" id="actionsDropdownMenu">
                            ...
                            <button class="dropdown-item coupon"
                                ...
                                تصدير مخصص</button>
                            <button class="dropdown-item" id="pastAttendanceDaysBtn"
                                onclick="showPastFridaysModal();closeAllDropdowns()"><i class="fas fa-calendar-alt"></i>
                                سجل أيام الحضور السابقة</button>
                            <button class="dropdown-item success" onclick="showAttendedModal();closeAllDropdowns()"><i
                                    class="fas fa-user-check"></i> عرض الحاضرين</button>
                            <button class="dropdown-item" onclick="showAbsentModal();closeAllDropdowns()"><i
                                    class="fas fa-user-times"></i> عرض الغائبين</button>
                        </div>
                    </div>
                    <div class="action-dropdown">
                        ...
                        <div class="dropdown-menu" id="couponsDropdownMenu">
                            ...
                            <button class="dropdown-item success" onclick="markAllPresent();closeAllDropdowns()"><i
                                    class="fas fa-check-circle"></i> حضور للجميع</button>
                            <button class="dropdown-item danger" onclick="markAllAbsent();closeAllDropdowns()"><i
                                    class="fas fa-times-circle"></i> غياب للجميع</button>
                            <div class="dropdown-divider"></div>
                            <div class="dropdown-group-label">الكوبونات الجماعية</div>
                            <button class="dropdown-item coupon" onclick="addCouponsToAll(10);closeAllDropdowns()"><i
                                    class="fas fa-star"></i> +10 كوبونات للجميع</button>
                            <button class="dropdown-item coupon" onclick="addCouponsToAll(30);closeAllDropdowns()"><i
                                    class="fas fa-star"></i> +30 كوبونات للجميع</button>
                            <button class="dropdown-item coupon" onclick="addCouponsToAll(50);closeAllDropdowns()"><i
                                    class="fas fa-star"></i> +50 كوبونات للجميع</button>
                            <button class="dropdown-item coupon" onclick="addCouponsToAll(100);closeAllDropdowns()"><i
                                    class="fas fa-star"></i> +100 كوبونات للجميع</button>
                            <div class="dropdown-divider"></div>
                            <button class="dropdown-item danger"
                                onclick="resetCouponDataForClass(currentClass);closeAllDropdowns()"><i
...
════════════════════════════════════════════ -->
    <div id="swipeOverlay">
        ...
        <div class="swipe-btns">
            ...
            <button class="swipe-present-btn" onclick="swipeDecide('present')"><i class="fas fa-check"></i>
                حضور</button>
...
════════════════════════════════════════════ -->
        ...
        <div class="modal">
            ...
            <form id="addPersonForm">
                <div class="form-group">
                    ...
                    <div class="photo-editor-section">
                        <div class="photo-circle-wrap" id="newStudentPhotoUploadArea"
                            ...
                            <img id="newStudentUploadPreview" class="photo-circle-img upload-preview" src="" alt=""
                                style="display:none">
                            <div class="photo-circle-placeholder" id="newStudentPhotoPlaceholder"><i
                ...
                <div class="form-group">
                    <label class="form-label">الفصل *</label>
                    <div class="input-icon-wrap"><i class="fas fa-chalkboard-teacher input-icon"></i><select
                            id="studentClass" class="form-input" required>
                            <option value="">اختر الفصل</option>
                        </select></div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label class="form-label">تاريخ الميلاد (DD/MM/YYYY)</label>
                    <div class="input-icon-wrap"><i class="fas fa-birthday-cake input-icon"></i><input type="text"
                            id="studentBirthday" class="form-input" placeholder="DD/MM/YYYY"></div>
                </div>
                <div class="form-group">
                ...
                <div style="display:flex;gap:8px">
                    ...
                    <button type="button" class="btn btn-secondary" id="cancelAddPersonModal" style="flex:1"><i
                ...
                <div class="export-controls">
                    ...
                    <div class="export-panel">
                        ...
                        <div class="export-date-options">
                            ...
                            <div id="customExportRangeInputs"
                                style="display:none;grid-template-columns:1fr 1fr;gap:6px">
                                <input type="text" class="form-input" id="customExportFromDate"
                                    placeholder="من DD/MM/YYYY" maxlength="10" inputmode="numeric"
                                    oninput="autoFormatCustomDate(this)">
                                <input type="text" class="form-input" id="customExportToDate"
                                    placeholder="إلى DD/MM/YYYY" maxlength="10" inputmode="numeric"
                                    oninput="autoFormatCustomDate(this)">
                            </div>
                            <textarea class="form-input" id="customExportDates"
                                placeholder="تواريخ مخصصة: 01/01/2026, 08/01/2026" rows="2"
                                style="display:none;min-height:54px"></textarea>
                        </div>
                    </div>
                    <button class="btn" id="customExportPreviewBtn" style="width:100%;justify-content:center"><i
                            class="fas fa-eye"></i> تحديث المعاينة</button>
                </div>
    ...
    <div class="modal-overlay" id="birthdayModal">
        <div class="modal modal-lg">
            ...
            <!-- Confetti container -->
            <div id="bdConfetti" style="position:fixed;inset:0;pointer-events:none;z-index:2000000;overflow:hidden">
            </div>
        </div>
    </div>
    ...
    <div id="bulkAddModal" class="modal-overlay" style="z-index:1000005">
        <div class="modal">
            <div class="modal-header">
                ...
                <button class="close-btn"
                    onclick="document.getElementById('bulkAddModal').classList.remove('active')">&times;</button>
            </div>
            <div style="margin-bottom:14px">
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:16px;">
                    <div
                        style="padding:12px;border-radius:10px;border:1.5px solid var(--success-dark);background:var(--success-bg);">
                        <div style="font-weight:700;font-size:0.85rem;color:#065f46;margin-bottom:4px;"><i
                                class="fas fa-plus-circle"></i> إضافة أطفال جدد</div>
                        <div style="font-size:0.77rem;color:#047857;">استخدم النموذج الفارغ. الأطفال المكررة تُتجاهل
                            تلقائياً.</div>
                        <button class="btn btn-sm" onclick="downloadTemplate()"
                            style="margin-top:8px;width:100%;background:var(--success);color:white;border:none;">
                            <i class="fas fa-download"></i> نموذج فارغ
                        </button>
                    </div>
                    <div
                        style="padding:12px;border-radius:10px;border:1.5px solid var(--brand);background:var(--brand-bg);">
                        <div style="font-weight:700;font-size:0.85rem;color:var(--brand);margin-bottom:4px;"><i
                                class="fas fa-sync-alt"></i> تحديث بيانات موجودة</div>
                        <div style="font-size:0.77rem;color:var(--brand);">حمّل بيانات الأطفال الحالية، عدّل ما تريد، ثم
                            أعد رفعه.</div>
                        <button class="btn btn-sm" onclick="downloadKidsData()"
                            style="margin-top:8px;width:100%;background:var(--brand);color:white;border:none;">
                ...
                <!-- Available classes -->
                <div id="bulkAvailableClasses"
                    style="margin-bottom:12px;padding:10px;background:var(--surface-3);border-radius:8px;font-size:0.82rem;color:var(--brand);display:none;">
                ...
                <!-- Errors / warnings -->
                <div id="bulkErrors"
                    style="display:none;margin-top:10px;padding:10px;background:var(--danger-bg);border-radius:8px;font-size:0.8rem;color:var(--danger);max-height:140px;overflow-y:auto;">
                </div>
            ...
            <div class="table-toolbar">
                ...
                <div class="table-export-btns">
                    ...
                    <button class="btn btn-danger" id="exportAllAsPdfBtn"><i class="fas fa-file-pdf"></i> تصدير
                        PDF</button>
                    <button class="btn btn-success" id="exportAllAsCsvBtn"><i class="fas fa-file-csv"></i> تصدير
                        CSV</button>
                </div>
            </div>
            ...
            <div style="padding:0 2px 10px">
                ...
                <div id="kidQrCouponSelectContainer" style="margin-bottom:12px; display:none;">
                    ...
                    <select id="kidQrCouponSelect" class="form-input" style="width:100%; padding: 8px 12px;" onchange="kidQrScanAmount = parseInt(this.value, 10); refreshKidQrScanUI();">
                        ...
                        <option value="100">100 كوبون</option>
                    </select>
                </div>
        ...
        <div class="modal modal-lg">
            ...
            <div class="custom-date-section" id="customDateSection" style="display:none">
                ...
                <div class="custom-date-inputs">
                    <input type="text" class="custom-date-input" id="customDateInput" placeholder="DD/MM/YYYY"
                        maxlength="10" inputmode="numeric" oninput="autoFormatCustomDate(this)"
                        onkeydown="if(event.key==='Enter')addCustomDate()">
                    <input type="text" class="custom-date-input" id="customDateLabel" placeholder="وصف (اختياري)"
    ...
    <div class="modal-overlay" id="deleteStudentModal" style="z-index:1000007">
        <div class="modal modal-sm" style="max-width:380px">
            ...
            <div style="display:flex;gap:10px">
                <button class="btn btn-danger" id="confirmDeleteStudentBtn" style="flex:1"><i class="fas fa-trash"></i>
                    نعم، احذف</button>
    ...
    <div class="modal-overlay" id="registrationDetailsModal">
        <div class="modal modal-lg">
            ...
            <div style="display:flex;gap:8px">
                <button class="btn btn-success" id="approveRegistrationBtn" style="flex:1"><i class="fas fa-check"></i>
                    الموافقة</button>
                <button class="btn btn-danger" id="rejectRegistrationBtn" style="flex:1"><i class="fas fa-times"></i>
                    الرفض</button>
            </div>
        </div>
    </div>
...
════════════════════════════════════════════ -->
    <script>
        ...
        // ── SAVE BUTTONS ──────────────────────────────────────────────
        function buildKidProfileQrLink(studentId) {
            const id = String(studentId || '').trim();
            if (!id) return '';
            return `${window.location.origin}/user/profile/?id=${encodeURIComponent(id)}`;
        }
            ...
            if (['attendance', 'coupons', 'profile'].includes(mode)) {
                ...
                if (container) {
                    if (mode === 'coupons') {
                        ...
                        const selectEl = document.getElementById('kidQrCouponSelect');
                        kidQrScanAmount = selectEl ? parseInt(selectEl.value, 10) || 10 : 10;
                    } else {
                        container.style.display = 'none';
                        kidQrScanAmount = 0;
                    }
        ...
        function refreshKidQrScanUI() {
            const title = document.getElementById('kidQrScannerTitle');
            const subtitle = document.getElementById('kidQrScannerSubtitle');
            const summary = document.getElementById('kidQrScanSummary');
            const list = document.getElementById('kidQrScanList');
            const doneBtn = document.getElementById('kidQrDoneBtn');
            const saveBtn = document.getElementById('kidQrSaveAllBtn');

            if (title) {
                title.innerHTML = kidQrScanMode === 'coupons'
                    ? '<i class="fas fa-qrcode"></i> مسح QR الكوبونات'
                    : kidQrScanMode === 'attendance'
                        ? '<i class="fas fa-qrcode"></i> مسح QR الحضور'
                        : '<i class="fas fa-qrcode"></i> مسح QR الطفل';
            }

            if (subtitle) {
                subtitle.textContent = kidQrScanMode === 'coupons'
                    ? `سيتم إضافة ${kidQrScanAmount} كوبون لكل طفل تقوم بمسحه`
                    : kidQrScanMode === 'attendance'
                        ? 'قم بمسح كود حضور الأطفال.'
                        : 'امسح QR الطفل لفتح ملفه مباشرة.';
            }
            ...
            if (saveBtn) {
                if (kidQrScanMode === 'profile') {
                    ...
                    const hasChanges = (changedStudents.size > 0 || changedCouponStudents.size > 0);
        ...
        function recordKidQrScan(studentId) {
            ...
            // Ensure class attendance data is loaded if scanning attendance
            if (kidQrScanMode === 'attendance' && !(studentCompositeId in attendanceData)) {
            ...
            if (kidQrScanMode === 'attendance') {
                ...
                updateSaveBtns();
            } else if (kidQrScanMode === 'coupons') {
                const amount = Math.max(1, parseInt(kidQrScanAmount, 10) || 1);
                const cur = parseInt(couponData[studentCompositeId] || 0);
                couponData[studentCompositeId] = cur + amount;
        ...
        async function saveAllGeneralChanges() {
            ...
            // Group changed attendance by class
            const attByClass = {};
            changedStudents.forEach(id => {
                const s = students.find(s => getStudentId(s) === id);
                if (!s) return;
                const realClass = s['الفصل'];
                if (!attByClass[realClass]) attByClass[realClass] = [];
                attByClass[realClass].push({ studentName: s['الاسم'].trim(), status: attendanceData[id] || 'pending' });
            });

            // Group changed coupons by class
            const coupByClass = {};
            changedCouponStudents.forEach(id => {
                const s = students.find(s => getStudentId(s) === id);
                if (!s) return;
                const realClass = s['الفصل'];
                if (!coupByClass[realClass]) coupByClass[realClass] = [];
                coupByClass[realClass].push({ studentName: s['الاسم'].trim(), coupons: Math.max(0, (parseInt(s['كوبونات الالتزام'] || 0)) + (parseInt(couponData[id] || 0))) });
            });

            const totalCalls = Object.keys(attByClass).length + Object.keys(coupByClass).length;
            if (totalCalls === 0) {
            ...
            const checkDone = () => {
                ...
                if (completedCalls === totalCalls) {
                    ...
                    if (errors.length > 0) {
                        ...
                        const affectedClasses = new Set([...Object.keys(attByClass), ...Object.keys(coupByClass)]);
                        affectedClasses.forEach(cn => {
                            saveAttendanceDataForClass(cn);
                            saveCouponDataForClass(cn);
                        });
            ...
            // Fire API calls for attendance
            Object.entries(attByClass).forEach(([cn, records]) => {
            ...
            // Fire API calls for coupons
            Object.entries(coupByClass).forEach(([cn, records]) => {
                makeApiCall({ action: 'updateCoupons', className: cn, couponData: JSON.stringify(records) }, d => {
                    checkDone();
                }, e => {
                    errors.push(e);
                    checkDone();
    ...
    `).join('');
        ...
        function openCropModal(src) {
            if (typeof Cropper === 'undefined') {
                showToast('جاري تحميل محرر الصور، حاول مجدداً...', 'warning');
                setTimeout(() => openCropModal(src), 500);
                return;
            }
        ...
        document.addEventListener('DOMContentLoaded', async () => {
            ...
            try {
                const role = (window.currentUncle && window.currentUncle.role) || localStorage.getItem('uncleRole') || '';
                ['bulkAddKidsBtn', 'homeBulkAddKidsBtn', 'allToolsBulkAddBtn'].forEach(id => {
