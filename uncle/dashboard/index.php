                ...
                if (source === 'usb') {
                    ...
                    if (readerEl) {
                        ...
                        readerEl.innerHTML = `
                            ...
                            <i class="fas fa-barcode" style="font-size:2.8rem;opacity:0.85;"></i>
                            <div style="font-weight:800;font-size:1.0rem;text-align:center;">الماسح الخارجي نشط</div>
                            <div style="display:flex;align-items:center;gap:6px;margin:6px 0;background:rgba(16,185,129,0.1);color:#10b981;padding:6px 12px;border-radius:20px;font-size:0.78rem;font-weight:700;">
                                <span style="width:8px;height:8px;background:#10b981;border-radius:50%;display:inline-block;animation:scanner-pulse 1.6s infinite ease-in-out;"></span>
                                جاهز لاستقبال المسح...
                            </div>
                            <div style="font-size:0.8rem;color:var(--text-3);text-align:center;max-width:280px;line-height:1.4;">قم بتوجيه قارئ الـ QR الخارجي نحو كروت الأطفال والمسح.</div>
                        `;
                    }
                } else {
                    // Source is camera
